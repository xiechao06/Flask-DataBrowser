$(function () { 
    ...
    var AdminForm = function() {
      ...
      this.applyGlobalStyles = function(parent) {
        ...
        $('[data-role=datepicker]', parent).datetimepicker({format:"yyyy-mm-dd", minView:"month", autoclose:true, language:"zh-CN", pickerPosition:"bottom-left"});
        $('[data-role=datetimepicker]', parent).datetimepicker({format:"yyyy-mm-dd hh:ii", autoclose:true, minuteStep:1, language:"zh-CN", pickerPosition:"bottom-left"});
      };
    };
