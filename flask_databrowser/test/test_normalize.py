...
class TestNormalize(basetest.BaseTest):
    ...
    def test_normalize_create_columns(self):
        ...
        class UserModelView(ModelView):
            ...
            __create_columns__ = [InputColumnSpec("id"), PlaceHolderColumnSpec("name", template_fname="foo.html", as_input=True)]
            __column_labels__ = {"id": u"号码", "name": u"姓名"} 
            __column_docs__ = {"id": u"编号", "name": u"名称"}
        ...
        class UserModelView(ModelView):
            ...
            __create_columns__ = [InputColumnSpec("id", label="id", doc="identity"), 
                                  PlaceHolderColumnSpec("name", label="name", doc="username", template_fname="foo.html", as_input=True)]
            __column_labels__ = {"id": u"号码", "name": u"姓名"} 
            __column_docs__ = {"id": u"编号", "name": u"名称"}
    ...
    def test_normalize_form_columns(self):
        ...
        class UserModelView(ModelView):
            ...
            __form_columns__ = [InputColumnSpec("id"), PlaceHolderColumnSpec("name", template_fname="foo.html", as_input=True)]
            __column_labels__ = {"id": u"号码", "name": u"姓名"} 
            __column_docs__ = {"id": u"编号", "name": u"名称"}
        ...
        class GroupModelView(ModelView):
            ...
            __form_columns__ = [TableColumnSpec("users", css_class="table table-striped table-hover table-condensed table-bordered")]
